<div class="btn-group forum-category">
...
$(document).ready(function(){
    ...
    $(".forum-category .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/forum.category.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".forum-category .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.forum-category .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'forum.category.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#forum-category-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#forum-category-list .btn-reset-filter').css('display', 'none');
