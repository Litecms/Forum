<div class="btn-group forum-question">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[category_id]" class="col-sm-2 control-label">
                                        {!! trans('forum::question.label.category_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[user_id]" class="col-sm-2 control-label">
                                        {!! trans('forum::question.label.user_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title]" class="col-sm-2 control-label">
                                        {!! trans('forum::question.label.title')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[viewcount]" class="col-sm-2 control-label">
                                        {!! trans('forum::question.label.viewcount')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[published]" class="col-sm-2 control-label">
                                        {!! trans('forum::question.label.published')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[status]" class="col-sm-2 control-label">
                                        {!! trans('forum::question.label.status')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[created_at]" class="col-sm-2 control-label">
                                        {!! trans('forum::question.label.created_at')!!}
                                    </label>
                                    <div class="col-sm-10">
...
$(document).ready(function(){
    ...
    $(".forum-question .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/forum.question.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".forum-question .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.forum-question .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'forum.question.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#forum-question-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#forum-question-list .btn-reset-filter').css('display', 'none');
