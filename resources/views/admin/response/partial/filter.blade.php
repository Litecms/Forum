<div class="btn-group forum-response">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[question_id]" class="col-sm-2 control-label">
                                        {!! trans('forum::response.label.question_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[question_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[best_answer]" class="col-sm-2 control-label">
                                        {!! trans('forum::response.label.best_answer')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[best_answer]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".forum-response .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/forum.response.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".forum-response .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.forum-response .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'forum.response.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#forum-response-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#forum-response-list .btn-reset-filter').css('display', 'none');
