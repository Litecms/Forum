            ...
            <ul class="media-list">
              <li class="media">
                ...
                <div class="media-body">
                  <h4 class="media-heading">{!! $forum['user']['name'] !!} <span class="text-muted pull-right"><small>{!! format_date($forum['created_at'])!!}</small></span></h4>
                  <p>{!! $forum['description'] !!} </p>
                    ...
                    <div class="media" id="{!! $value->getRouteKey() !!}">
                      ...
                      <div class="media-body">
                        <h4 class="media-heading">{!! $value['user']['name'] !!} @if($value['best_answer'] == 1)<i class="ion-android-checkmark-circle text-success"></i> @endif<span class="text-muted pull-right"><small>{!! format_date($value['created_at'])!!}</small></span></h4>
