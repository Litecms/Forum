...
class CategoryResourceController extends BaseController
{
    ...
    public function show(CategoryRequest $request, Category $category)
    {
        ...
        return $this->response->setMetaTitle(trans('app.view') . ' ' . trans('forum::category.name'))
    ...
    public function create(CategoryRequest $request)
    {
        ...
        return $this->response->setMetaTitle(trans('app.new') . ' ' . trans('forum::category.name')) 
    ...
    {
        return $this->response->setMetaTitle(trans('app.edit') . ' ' . trans('forum::category.name'))
