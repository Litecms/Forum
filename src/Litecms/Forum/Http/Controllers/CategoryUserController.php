...
use Form;
use Litecms\Forum\Http\Requests\CategoryUserRequest;
...
class CategoryUserController extends BaseController
{
    ...
    {
        $this->repository->pushCriteria(new \Litecms\Forum\Repositories\Criteria\CategoryUserCriteria());
        ...
        return $this->theme->of('forum::user.category.index', compact('categories'))->render();
    }
    ...
    public function show(CategoryUserRequest $request, Category $category)
    {
        ...
        return $this->theme->of('forum::user.category.show', compact('category'))->render();
    }
    ...
    public function create(CategoryUserRequest $request)
    {
        ...
        return $this->theme->of('forum::user.category.create', compact('category'))->render();
    }
    ...
    public function edit(CategoryUserRequest $request, Category $category)
    {
        ...
        return $this->theme->of('forum::user.category.edit', compact('category'))->render();
    }
    ...
    public function update(CategoryUserRequest $request, Category $category)
    {
        try {
            ...
            return redirect(trans_url('/user/forum/category'))
                ->with('message', trans('messages.success.updated', ['Module' => trans('forum::category.name')]))
                ->with('code', 204);
    ...
    public function destroy(CategoryUserRequest $request, Category $category)
    {
        try {
            ...
            return redirect(trans_url('/user/forum/category'))
                ->with('message', trans('messages.success.deleted', ['Module' => trans('forum::category.name')]))
                ->with('code', 204);
